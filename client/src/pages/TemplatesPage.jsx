            ...
            <header className="mb-12">
                ...
                >
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Quick Start</span>
                    </div>
                    <h1 className="text-3xl font-semibold text-zinc-100 mb-2">Templates</h1>
                    <p className="text-zinc-500 text-sm max-w-xl">
                        Pre-built habit bundles to help you achieve your goals faster.
                    </p>
                </motion.div>
            </header>
