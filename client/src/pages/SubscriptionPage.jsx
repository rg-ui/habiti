    ...
    return (
        <div className="max-w-4xl mx-auto py-6 md:py-12 px-4 md:px-6">
            <div className="text-center mb-10 md:mb-16">
                ...
                <h1 className="text-3xl md:text-5xl font-bold text-slate-900 mb-4 md:mb-6 tracking-tight">Invest in your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-indigo-700">Identity.</span></h1>
            ...
            <div className="flex justify-center mb-8 md:mb-12">
                <div className="bg-white p-1.5 rounded-2xl flex shadow-sm border border-slate-100 w-full max-w-sm md:w-auto">
                    <button
                        onClick={() => setBillingCycle('monthly')}
                        className={`flex-1 md:flex-none px-4 md:px-8 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${billingCycle === 'monthly' ? 'bg-indigo-600 shadow-lg shadow-indigo-500/20 text-white' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                        Monthly
                    </button>
                    <button
                        onClick={() => setBillingCycle('yearly')}
                        className={`flex-1 md:flex-none px-4 md:px-8 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 ${billingCycle === 'yearly' ? 'bg-indigo-600 shadow-lg shadow-indigo-500/20 text-white' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                        Yearly <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wide whitespace-nowrap ${billingCycle === 'yearly' ? 'bg-white/20 text-white' : 'bg-green-100 text-green-700'}`}>Save 20%</span>
                    </button>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-start">
                {/* Free Tier */}
                <div className="glass-card p-6 md:p-8 rounded-[2rem] border border-slate-200/60 bg-white/50 relative md:top-8 order-2 md:order-1">
                    ...
                    <div className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 md:mb-8 tracking-tight">₹0 <span className="text-base font-medium text-slate-400">/ forever</span></div>
                    ...
                    <button className="w-full py-3 md:py-4 rounded-2xl border border-slate-200 font-bold text-slate-500 hover:bg-slate-50 hover:text-slate-800 transition-all text-sm uppercase tracking-wide">
                        Current Plan
                    </button>
                </div>
                ...
                <motion.div
                    ...
                    className="relative p-1 rounded-[2.5rem] bg-gradient-to-b from-[#d4af37] to-slate-900 shadow-2xl shadow-[#d4af37]/20 order-1 md:order-2"
                >
                    <div className="bg-slate-900 rounded-[2.3rem] p-6 md:p-8 h-full relative overflow-hidden">
                        ...
                        <div className="flex justify-between items-start mb-2 relative z-10 transition-all">
                        ...
                        <ul className="space-y-4 mb-8 md:mb-10 relative z-10">
                            {features.map((feature, i) => (
                                <li key={i} className="flex items-center gap-4 text-slate-300 text-sm font-medium">
                                    <div className="p-1 bg-[#d4af37]/20 rounded-full border border-[#d4af37]/20 flex-shrink-0">
                        ...
                        <div className="mt-8 bg-white/5 p-6 rounded-3xl backdrop-blur-md border border-white/5 relative z-10">
                            ...
                            <div className="text-center overflow-hidden">
                                ...
                                <div className="flex items-center justify-center gap-2 bg-black/40 p-3 rounded-xl border border-white/5 transition-all hover:bg-black/60 cursor-pointer overflow-x-auto">
                                    <code className="text-xs md:text-sm font-mono text-[#d4af37] tracking-wide select-all whitespace-nowrap">7439250914@kotak811</code>
                                </div>
                            </div>
                        </div>

                        <button className="w-full mt-8 py-3 md:py-4 rounded-2xl bg-gradient-to-r from-[#d4af37] to-[#eacda3] text-slate-900 font-bold hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-[#d4af37]/20 relative z-10 uppercase text-sm tracking-wide">
                            Confirm Payment
                        </button>
                    </div>
                </motion.div>
