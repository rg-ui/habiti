...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-950">
            {/* Background blobs */}
            <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-teal-500/10 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[800px] h-[800px] bg-emerald-500/20 rounded-full blur-[120px] pointer-events-none" />
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-300 mt-2 text-sm font-medium">Continue building your best self.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex justify-end mt-2">
                            <Link to="#" className="text-xs font-semibold text-slate-500 hover:text-amber-500 transition-colors">Forgot Password?</Link>
                        </div>
                    </div>
                ...
                <p className="mt-8 text-center text-slate-300 text-sm font-medium">
                    New here? <Link to="/signup" className="text-teal-400 font-bold hover:text-teal-300 transition-colors">Create account</Link>
                </p>
            </motion.div>
        </div>
    );
